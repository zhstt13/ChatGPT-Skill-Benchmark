...
The original `ai-repository-engineer` candidate synthesizes ideas from these references, but must be benchmarked against the same cases as narrower Candidates. A source link is never evidence that the Candidate performs well.
